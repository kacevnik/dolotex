<?php 
    ...
    if($taxonomy->taxonomy == 'cat_sistem'){
...
?>
      <section id="catalog">
        <div class="container">
          <?php if($category_sistem_list){ ?>
          <div class="breadcrumbs bold_500">
            <?php if( function_exists('kama_breadcrumbs') ) kama_breadcrumbs(' / '); ?>
          </div>
          <h1><?php echo $taxonomy->name; ?></h1>
          <?php foreach ($category_sistem_list as $category_sistem_list_item) { ?>
            <div class="sub_cat_item">
              <h4 class="sub_cat_title"> 
                <a href="<?php echo get_term_link($category_sistem_list_item->term_id); ?>"><?php echo $category_sistem_list_item->name; ?></a>
              </h4>
              <div class="row">
                <?php 
                  $args_posts_tovar = array(
                  ...
                  $posts_tovar = query_posts($args_posts_tovar);
                  foreach($posts_tovar as $posts_tovar_item){
                ?>
                <div class="col-md-3 col-sm-6">
                  <div class="catalog_item">
                    ...
                    ?>
                    <h3>
                      <a href="<?php echo get_permalink($posts_tovar_item->ID); ?>" data-name-product="<?php echo $posts_tovar_item->post_title; ?>"><?php echo $posts_tovar_item->post_title; ?></a>
                    </h3>
